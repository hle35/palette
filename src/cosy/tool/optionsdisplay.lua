...
--]]
  ...
  optionsdisplay.options = {
	...
	local checked = "checked=\"checked\""
        ...
        html = html .. "<label class=\"control-label col-sm-2\">" .. opt.name .. "</label> <input  class=\"col-sm-1\" type=\"checkbox\" id=\"" .. opt.key .. "\"" .. checked .. "/>"
        html = html .. "</div>"
...
--]]
    number_parameter = {
      ...
      render    = function (opt)
        ...
        html = html .. "<input type=\"text\" class=\"form-control\" id=\"opt.key\"  value=\"" .. opt.default .."\">"
        html = html .. "</div>"
        html = html .. "<span class=\"glyphicon glyphicon-info-sign\" data-toggle=\"tooltip\" title=\"" .. opt.description .."\"></span>"
        html = html .. "</div>"
        return html
